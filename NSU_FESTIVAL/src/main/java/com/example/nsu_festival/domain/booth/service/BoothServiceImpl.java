...
//    }
    ...
    public void initializeData() {
        // 부스 1
        Booth booth1 = new Booth(1L, "가상현실학과", "내용1", 0L, "a-1", "https://nsufestival.s3.ap-northeast-2.amazonaws.com/2.png", null, null, null, null);
        ...
        // 부스 2
        Booth booth2 = new Booth(2L, "뷰티보건학과", "내용2", 0L, "a-2", "이미지URL2", null, null, null, null);
        ...
        // 이하 반복
        // 부스 3
        Booth booth3 = new Booth(3L, "멀티미디어학과", "내용3", 0L, "a-3", "이미지URL3", null, null, null, null);
        ...
        // 부스 4
        Booth booth4 = new Booth(4L, "유통마케팅학과", "내용4", 0L, "a-4", "이미지URL4", null, null, null, null);
        ...
        // 부스 5
        Booth booth5 = new Booth(5L, "글로벌무역학과", "내용5", 0L, "a-5", "이미지URL5", null, null, null, null);
        ...
        // 부스 6
        Booth booth6 = new Booth(6L, "영상예술디자인학과", "내용6", 0L, "a-6", "이미지URL6", null, null, null, null);
...
// 부스 7
        Booth booth7 = new Booth(7L, "컴퓨터소프트웨어학과", "내용7", 0L, "a-7", "이미지URL7", null, null, null, null);
...
// 부스 8
        Booth booth8 = new Booth(8L, "스포츠비즈니스학과", "내용8", 0L, "a-8", "이미지URL8", null, null, null, null);
...
// 부스 9
        Booth booth9 = new Booth(9L, "물리치료학과", "내용9", 0L, "a-9", "이미지URL9", null, null, null, null);
...
// 부스 10
        Booth booth10 = new Booth(10L, "전자공학과", "내용10", 0L, "a-10", "이미지URL10", null, null, null, null);
        ...
        // 부스 11
        Booth booth11 = new Booth(11L, "아동복지학과", "내용11", 0L, "a-11", "이미지URL11", null, null, null, null);
...
// 부스 12
        Booth booth12 = new Booth(12L, "실용음악학과", "내용12", 0L, "a-12", "이미지URL12", null, null, null, null);
...
// 부스 13
        Booth booth13 = new Booth(13L, "세무학과", "내용13", 0L, "a-13", "이미지URL13", null, null, null, null);
...
// 부스 14
        Booth booth14 = new Booth(14L, "중국학과", "내용14", 0L, "a-14", "이미지URL14", null, null, null, null);
...
// 부스 15
        Booth booth15 = new Booth(15L, "건축공학과", "내용15", 0L, "a-15", "이미지URL15", null, null, null, null);
        ...
        // 부스 16
        Booth booth16 = new Booth(16L, "임상병리학과", "내용16", 0L, "a-16", "이미지URL16", null, null, null, null);
...
// 부스 17
        Booth booth17 = new Booth(17L, "보건행정학과", "내용17", 0L, "a-17", "이미지URL17", null, null, null, null);
...
// 부스 18
        Booth booth18 = new Booth(18L, "일어일문학과", "내용18", 0L, "a-18", "이미지URL18", null, null, null, null);
...
// 부스 19
        Booth booth19 = new Booth(19L, "스마트팜학과", "내용19", 0L, "a-19", "이미지URL19", null, null, null, null);
...
// 부스 20
        Booth booth20 = new Booth(20L, "바이오헬스컨디셔닝학과", "내용20", 0L, "a-20", "이미지URL20", null, null, null, null);
        ...
        // 부스 21
        Booth booth21 = new Booth(21L, "건축학과", "내용21", 0L, "a-21", "이미지URL21", null, null, null, null);
...
// 부스 22
        Booth booth22 = new Booth(22L, "빅데이터경영공학과", "내용22", 0L, "a-22", "이미지URL22", null, null, null, null);
...
// 부스 23
        Booth booth23 = new Booth(23L, "영어과", "내용23", 0L, "a-23", "이미지URL23", null, null, null, null);
...
// 부스 24
        Booth booth24 = new Booth(24L, "호텔경영학과", "내용24", 0L, "a-24", "이미지URL24", null, null, null, null);
...
// 부스 25
        Booth booth25 = new Booth(25L, "시각미디어디자인학과", "내용25", 0L, "a-25", "이미지URL25", null, null, null, null);
        ...
        // 부스 26
        Booth booth26 = new Booth(26L, "경영학과", "내용26", 0L, "a-26", "이미지URL26", null, null, null, null);
...
// 부스 27
        Booth booth27 = new Booth(27L, "스포츠건강관리학과", "내용27", 0L, "a-27", "이미지URL27", null, null, null, null);
...
// 부스 28
        Booth booth28 = new Booth(28L, "관광경영학과", "내용28", 0L, "a-28", "이미지URL28", null, null, null, null);
...
// 부스 29
        Booth booth29 = new Booth(29L, "사회복지학과", "내용29", 0L, "a-29", "이미지URL29", null, null, null, null);
...
// 부스 30
        Booth booth30 = new Booth(30L, "광고홍보학과", "내용30", 0L, "a-30", "이미지URL30", null, null, null, null);
        ...
        // 부스 31
        Booth booth31 = new Booth(31L, "지능정보통신공학과", "내용31", 0L, "a-31", "이미지URL31", null, null, null, null);
...
// 부스 32
        Booth booth32 = new Booth(32L, "간호학과", "내용32", 0L, "a-32", "이미지URL32", null, null, null, null);
...
// 부스 33
        Booth booth33 = new Booth(33L, "공간조형디자인학과", "내용33", 0L, "a-33", "이미지URL33", null, null, null, null);
...
// 부스 34
        Booth booth34 = new Booth(34L, "치위생학과", "내용34", 0L, "a-34", "이미지URL34", null, null, null, null);
...
// 부스 35
        Booth booth35 = new Booth(35L, "부동산학과", "내용35", 0L, "a-35", "이미지URL35", null, null, null, null);
        ...
        // 부스 36
        Booth booth36 = new Booth(36L, "드론공간정보공학과", "내용36", 0L, "a-36", "이미지URL36", null, null, null, null);
...
// 부스 37
        Booth booth37 = new Booth(37L, "휴먼케어학과", "내용37", 0L, "a-37", "이미지URL37", null, null, null, null);
...
// 부스 38
        Booth booth38 = new Booth(38L, "응급구조학과", "내용38", 0L, "a-38", "이미지URL38", null, null, null, null);
        ...
        // 부스 39
        Booth booth39 = new Booth(39L, "굿네이버스", "내용39", 0L, "a-38", "이미지URL39", null, null, null, null);
        ...
        // 부스 40
        Booth booth40 = new Booth(40L, "라파엘", "내용40", 0L, "a-40", "이미지URL40", null, null, null, null);
...
// 부스 41
        Booth booth41 = new Booth(41L, "KOZ", "내용41", 0L, "a-41", "이미지URL41", null, null, null, null);
        ...
        // 부스 42
        Booth booth42 = new Booth(42L, "아랑", "내용42", 0L, "a-42", "이미지URL42", null, null, null, null);
...
// 부스 43
        Booth booth43 = new Booth(43L, "창틀", "내용43", 0L, "a-43", "이미지URL43", null, null, null, null);
...
// 부스 44
        Booth booth44 = new Booth(44L, "저스트댄스", "내용44", 0L, "a-44", "이미지URL44", null, null, null, null);
...
// 부스 45
        Booth booth45 = new Booth(45L, "닉샷", "내용45", 0L, "a-45", "이미지URL45", null, null, null, null);
...
// 부스 46
        Booth booth46 = new Booth(46L, "SENS", "내용46", 0L, "a-46", "이미지URL46", null, null, null, null);
...
// 부스 47
        Booth booth47 = new Booth(47L, "C.C.C", "내용47", 0L, "a-47", "이미지URL47", null, null, null, null);
        ...
        // 부스 48
        Booth booth48 = new Booth(48L, "로타랙트", "내용48", 0L, "a-48", "이미지URL48", null, null, null, null);
...
// 부스 49
        Booth booth49 = new Booth(49L, "소리터", "내용49", 0L, "a-49", "이미지URL49", null, null, null, null);
...
// 부스 50
        Booth booth50 = new Booth(50L, "groove", "내용50", 0L, "a-50", "이미지URL50", null, null, null, null);
...
// 부스 51
        Booth booth51 = new Booth(51L, "케렌시아", "내용51", 0L, "a-51", "이미지URL51", null, null, null, null);
...
// 부스 52
        Booth booth52 = new Booth(52L, "새마을", "내용52", 0L, "a-52", "이미지URL52", null, null, null, null);
...
// 부스 53
        Booth booth53 = new Booth(53L, "아름다운 사람들", "내용53", 0L, "a-53", "이미지URL53", null, null, null, null);
        ...
        // 부스 54
        Booth booth54 = new Booth(54L, "제너시스", "내용54", 0L, "a-54", "이미지URL54", null, null, null, null);
...
// 부스 55
        Booth booth55 = new Booth(55L, "SHOUT", "내용55", 0L, "a-55", "이미지URL55", null, null, null, null);
...
// 부스 56
        Booth booth56 = new Booth(56L, "NVP", "내용56", 0L, "a-56", "이미지URL56", null, null, null, null);
        ...
        // 부스 57
        Booth booth57 = new Booth(57L, "노스텔지어", "내용57", 0L, "a-57", "이미지URL57", null, null, null, null);
...
// 부스 58
        Booth booth58 = new Booth(58L, "아우트런스", "내용58", 0L, "a-58", "이미지URL58", null, null, null, null);
...
// 부스 59
        Booth booth59 = new Booth(59L, "애니지크", "내용59", 0L, "a-59", "이미지URL59", null, null, null, null);
        ...
        // 부스 60
        Booth booth60 = new Booth(60L, "대학혁신지원사업단", "내용60", 0L, "a-60", "이미지URL60", null, null, null, null);
...
// 부스 61
        Booth booth61 = new Booth(61L, "LEAF", "내용61", 0L, "a-61", "이미지URL61", null, null, null, null);
...
// 부스 62
        Booth booth62 = new Booth(62L, "카르페디엠", "내용62", 0L, "a-62", "이미지URL62", null, null, null, null);
        ...
        // 부스 63
        Booth booth63 = new Booth(63L, "C.O.M.E", "내용63", 0L, "a-63", "이미지URL63", null, null, null, null);
...
// 부스 64
        Booth booth64 = new Booth(64L, "NSTV", "내용64", 0L, "a-64", "이미지URL64", null, null, null, null);
...
// 부스 65
        Booth booth65 = new Booth(65L, "애드밴처", "내용65", 0L, "a-65", "이미지URL65", null, null, null, null);
...
// 부스 66
        Booth booth66 = new Booth(66L, "아메리타트", "내용66", 0L, "a-66", "이미지URL66", null, null, null, null);
...
// 부스 67
        Booth booth67 = new Booth(67L, "SCON", "내용67", 0L, "a-67", "이미지URL67", null, null, null, null);
...
// 부스 68
        Booth booth68 = new Booth(68L, "대외국제교류처1", "내용68", 0L, "a-68", "이미지URL68", null, null, null, null);
        ...
        // 부스 69
        Booth booth69 = new Booth(69L, "대외국제교류처2", "내용69", 0L, "a-69", "이미지URL69", null, null, null, null);
...
// 부스 70
        Booth booth70 = new Booth(70L, "대외국제교류처3", "내용70", 0L, "a-70", "이미지URL70", null, null, null, null);
