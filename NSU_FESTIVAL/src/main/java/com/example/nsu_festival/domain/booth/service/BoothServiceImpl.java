...
// 부스 7
        Booth booth7 = new Booth(7L, "휴먼케어학과", "사진관 및 거짓말 탐지기", boothLikedRepository.existsByBoothId(7L)? boothLikedRepository.countBoothLike(7L) : 0, "A-8", department.get(6),null,"휴케사진관",null, null, null, null);
...
// 부스 8
        Booth booth8 = new Booth(8L, "스포츠비즈니스학과", "물총사격, 번호추첨 로또", boothLikedRepository.existsByBoothId(8L)? boothLikedRepository.countBoothLike(8L) : 0, "A-7", department.get(7),null,null,null, null,  null, null);
...
// 부스 68
        ...
        // 부스 69
        Booth booth69 = new Booth(69L, "대회협력처C", "등록된 내용이 없습니다.", boothLikedRepository.existsByBoothId(69L)? boothLikedRepository.countBoothLike(69L) : 0, "a-69", clubImage.get(33), null,null,null, null, null, null);
